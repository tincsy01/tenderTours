...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="../../Admin/Admin/index.html" class="logo d-flex align-items-center">
            <img src="../../Admin/Admin/assets/img/logo.png" alt="">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                    ...
                    <li class="message-item">
                        <a href="#">
                            <img src="../../Admin/Admin/assets/img/messages-1.jpg" alt="" class="rounded-circle">
                            <div>
                                <h4>Maria Hudson</h4>
                    ...
                    <li class="message-item">
                        <a href="#">
                            <img src="../../Admin/Admin/assets/img/messages-2.jpg" alt="" class="rounded-circle">
                            <div>
                                <h4>Anna Nelson</h4>
                                <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                <p>6 hrs. ago</p>
                    ...
                    <li class="message-item">
                        <a href="#">
                            <img src="../../Admin/Admin/assets/img/messages-3.jpg" alt="" class="rounded-circle">
                            <div>
                                <h4>David Muldon</h4>
                                <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                <p>8 hrs. ago</p>
...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="../../Admin/Admin/index.html">
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="../../Admin/Admin/forms-elements.html" class="active">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="../includes/add_organization.php">
                            ...
                            <div class="row mb-3">
                                <label for="inputPassword" class="col-sm-2 col-form-label">From organization</label>
                                <div class="col-sm-10">
...
<footer id="footer" class="footer">
    <div class="copyright">
        &copy; Copyright <strong><span>TenderTours</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
